        ...
        If MCBackup.Language.IsLoaded Then
            Select Case Button
                Case MessageBoxButton.OK
                    ...
                    MsgBox.Button1.Content = MCBackup.Language.GetString("MetroMsgBox.Button.OK")
                ...
                Case MessageBoxButton.OKCancel
                    MsgBox.Button1.Visibility = Visibility.Visible
                    MsgBox.Button1.Content = MCBackup.Language.GetString("MetroMsgBox.Button.Cancel")
                    MsgBox.Button1.Tag = MessageBoxResult.Cancel
                    MsgBox.Button2.Visibility = Visibility.Visible
                    MsgBox.Button2.Content = MCBackup.Language.GetString("MetroMsgBox.Button.OK")
                    MsgBox.Button2.Tag = MessageBoxResult.OK
                    MsgBox.Button3.Visibility = Visibility.Collapsed
                Case MessageBoxButton.YesNo
                    MsgBox.Button1.Visibility = Visibility.Visible
                    MsgBox.Button1.Content = MCBackup.Language.GetString("MetroMsgBox.Button.No")
                    MsgBox.Button1.Tag = MessageBoxResult.No
                    MsgBox.Button2.Visibility = Visibility.Visible
                    MsgBox.Button2.Content = MCBackup.Language.GetString("MetroMsgBox.Button.Yes")
                ...
                Case MessageBoxButton.YesNoCancel
                    ...
                    MsgBox.Button1.Tag = MessageBoxResult.Cancel
                    MsgBox.Button2.Visibility = Visibility.Visible
                    MsgBox.Button2.Content = MCBackup.Language.GetString("MetroMsgBox.Button.No")
                    MsgBox.Button2.Tag = MessageBoxResult.No
                    MsgBox.Button3.Visibility = Visibility.Visible
                    MsgBox.Button3.Content = MCBackup.Language.GetString("MetroMsgBox.Button.Yes")
