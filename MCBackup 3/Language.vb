...
Public Class Language
    ...
    Public Shared Sub Load(FileName As String)
        ...
        Dictionary.Add("AutoBackupWindow.SaveAsLabel.Content", FindString("AutoBackupWindow.SaveAsLabel.Content"))
        Dictionary.Add("AutoBackupWindow.PrefixLabel.Content", FindString("AutoBackupWindow.PrefixLabel.Content"))
        Dictionary.Add("AutoBackupWindow.SuffixLabel.Content", FindString("AutoBackupWindow.SuffixLabel.Content"))
